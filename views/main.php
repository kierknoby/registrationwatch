				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<p class="help-block" style="margin-top:24px;margin-bottom:16px;"><strong><?php echo _('Per-extension repeat overrides can be set in the Watched Extensions table.'); ?></strong></p>
